...
<div class="container" style="margin-top: 100px;">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="thumbnail">
                <img src="image/produk/" width="400">
            </div>
        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-success mr-2" data-toggle="modal"
                                            data-target="#ubahModal">Ubah Jumlah Pesanan</button>
                                    </span>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" name="submit">Simpan dan Tambahkan ke
                                    Keranjang</button>
                            </div>
                        </div>
                    </div>
