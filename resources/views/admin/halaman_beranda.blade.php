...
<body class="nav-md">
    <div class="container body">
        ...
        <button type='submit' class='btn btn-primary' name='submit-update'><i class='mdi mdi-content-save-outline'></i> Simpan Perubahan </button>
        <button type='submit' class='btn btn-danger' name='submit-delete'><i class='mdi mdi-delete-outline'></i>  Hapus</button>
        </form>

        <form method='POST' style='margin-top:3%; margin-bottom:10%'>
        ...
        <button type='submit' class='btn btn-success' name='submit-tambah'><i class='mdi mdi-plus-circle-outline'></i> Tambah</button>
        </form>
        </div>
        </div>
